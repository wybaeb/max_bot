...
Лёгкий Node.js-мост, который автоматически репостит сообщения из **Telegram**-каналов и групп в каналы **MAX** (max.ru) — с поддержкой форматирования текста, изображений, видео, аудио и файловых вложений.
...
Поддерживаемые сети-источники: `telegram`, `max`.  
